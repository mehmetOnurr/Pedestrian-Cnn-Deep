# pytorch ile pedestrian classfication
import torch
...
#%% Read train positive
train_positive_path = "LSIFIR/Classification/Train/pos"
...
print("x_train_negative_tensor:", x_train_positive_tensor.size())

y_train_positive_tensor = torch.zeros(num_train_positive_img, dtype= torch.long)
print("y_train_negative_tensor:", y_train_positive_tensor.size())
...
test_positive_path = "LSIFIR/Classification/Test/pos"
